...
class ModalManager {
    ...
    setupEventListeners() {
        ...
        document.getElementById('newAdminBtn').addEventListener('click', (e) => {
            e.preventDefault();
            window.location.href = '/admin/kelolabooking/kelolabooking';
        });
...
class LaporanManager {
    constructor() {
        // Load data from server (injected by LaporanController)
        this.totalRevenue = window.totalRevenue || 0;
        this.totalBookings = window.totalBookings || 0;
        this.totalMitra = window.totalMitra || 0;
        this.totalCustomers = window.totalCustomers || 0;
        this.topMitras = window.topMitras || [];
        this.monthlyRevenue = window.monthlyRevenue || [];
        this.recentWithdrawals = window.recentWithdrawals || [];
