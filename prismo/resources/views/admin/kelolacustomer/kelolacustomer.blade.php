...
<head>
    <meta charset="UTF-8" />
    <title>Kelola Customer - Prismo</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="user-role" content="admin">
    <link rel="stylesheet" href="{{ asset('css/kelolacustomer.css') }}" />
</head>
<body>
    <!-- ====== MODAL KONFIRMASI ====== -->
    ...
    <div id="banModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3>Konfirmasi Nonaktifkan Customer</h3>
            </div>
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menonaktifkan customer <strong id="banCustomerName"></strong>?</p>
                <small style="color: #666; margin-top: 8px; display: block;">Customer yang dinonaktifkan tidak dapat login ke sistem.</small>
            </div>
            <div class="modal-footer">
    ...
    <div id="unbanModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3>Konfirmasi Aktifkan Customer</h3>
            </div>
            <div class="modal-body">
                <p>Apakah Anda yakin ingin mengaktifkan kembali customer <strong id="unbanCustomerName"></strong>?</p>
            </div>
            <div class="modal-footer">
        ...
        <section class="customer-section">
            ...
            <div class="card table-card">
                <div class="customer-header">
                    <h1 class="customer-title">Kelola Data Customer</h1>
    ...
    <script>
        // Inject real customer data from server
    ...
    <script src="{{ asset('js/kelolacustomer.js') }}"></script>
</body>
</html>
