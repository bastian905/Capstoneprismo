...
<head>
    ...
    <title>{{ isset($isLogin) && $isLogin ? 'Login' : 'Register' }} | Prismo</title>
...
<body>
    ...
    <div class="form-container sign-up">
        <form id="signup-form" method="POST" action="{{ route('register.store') }}">
            ...
            <div class="input-container email">
                <input type="email" name="email" placeholder="Email" autocomplete="email" required value="{{ old('email') }}">
            </div>
    ...
    <div class="form-container sign-in">
        <form id="signin-form">
            ...
            <button type="button" class="google-btn" onclick="window.location.href='{{ route('auth.google') }}'">
                <img src="{{ asset('images/google.png') }}" alt="Google" class="google-icon">
                Lanjut dengan Google
            </button>
    ...
    <div class="forgot-password-modal" id="forgotPasswordModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="forgot-password-form" id="forgot-password-form" method="POST" action="{{ route('auth.magic-link') }}">
                    @csrf
    ...
    @if(request()->has('tab') && request()->get('tab') === 'register')
    <script>
    ...
    @if(request()->has('tab') && request()->get('tab') === 'login')
    <script>
